...
def setup_module(mod):
    ...
    * `mod`: module name
    ...
    # Start fpmsyncd simutlation first 
    d1 = tgen.gears["d1"]
    d1.startFpmsyncd()
...
def test_fpmsyncd():
    ...
    route_num = int(os.popen("cat /tmp/topotests/fpmsyncd_evpn5_test.test_fpmsyncd_evpn5/d1/routes.json |grep Evpn |wc -l").read())
    
    assert route_num != 0 , "fpmsyncd failed"
